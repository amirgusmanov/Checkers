...
public class CheckerFiller implements CheckerGenerator {
    ...
    public void checkerFiller() {
        ...
        for (CheckersDeskBoardCoordinate coordinates : coordinateList) {
            switch (i) {
                case 2, 4, 6, 8, 9, 11, 13, 15, 18, 20, 22, 24 ->
                        game.getCheckerList().add(new SimpleChecker(coordinates, false));
                case 41, 43, 45, 47, 50, 52, 54, 56, 57, 59, 61, 63 ->
                        game.getCheckerList().add(new SimpleChecker(coordinates, true));
            }
            i++;
        }
    }
    ...
    public void setGame(Desk game) {
        this.game = game;
    }

    public List<CheckersDeskBoardCoordinate> getCoordinateList() {
        return coordinateList;
    }

    public void setCoordinateList(List<CheckersDeskBoardCoordinate> coordinateList) {
        this.coordinateList = coordinateList;
    }
